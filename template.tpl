...

{
  ...
  "description": "Das Productview Tracking wird auf Produktdetailseiten ausgespielt und enthält wichtige Informationen zum aktuell betrachteten Produkt, wie die Artikelnummer, den Preis oder auch den Namen des Produkts",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "TEXT",
    "name": "inputVal",
    "displayName": "trbo Productview (Array)",
    "simpleValueType": true,
    "valueHint": "{{trbo productView}}",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      }
    ],
    "help": "Ein Array mit den Produktobjekten, für die ein View gemessen werden soll (meistens ein Produkt). Informationen über die Produktobjekte finden Sie in der Anleitung oder der Productview Variablen in der GTM Gallerie"
  }
]
...
const trbo_productDetail = data.inputVal;

const trboqPush = createQueue('_trboq');
trboqPush(["productView",{products: trbo_productDetail}]);
